...
import { Palette, Key, Shield, Mail, Video, MessageSquare, FolderGit2, Book, Plug, MessagesSquare, Settings, Database } from 'lucide-react';
...
type TabType = 'branding' | 'codes' | 'roles' | 'email' | 'integrations' | 'integration-manager' | 'database';
type IntegrationType = 'meetings' | 'chat' | 'forum' | 'collaboration' | 'docs';

const Admin = () => {
  const [activeTab, setActiveTab] = useState<TabType>('database'); // Changed default to database
